...
#This is plot 3 of the assignement 1
#This particular script is trying to plot line graph for all 3 submetering
...
#Plot and add lines for 3 submetering variables
